...
renderValueBox(
  valueBox(ReactiveLongestLoseStreak()
           ,color = ifelse(ReactiveLongestLoseStreak() < 4 ,"success" ,ifelse(ReactiveLongestWinStreak() < 6  ,"warning" ,"danger")))
)
...
renderValueBox(
  valueBox(ReactiveCurrentLoseStreak()
           ,color = ifelse(ReactiveCurrentLoseStreak() == 0, "success" ,ifelse(ReactiveCurrentWinStreak() < 3  ,"warning" ,"danger")))
)
